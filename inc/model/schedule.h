...
public:
    ...
    int _submission_time; /**< time this schedule gets submittet */
    /**
     ...
     * @param core
     *   id of cpu this schedule gets executed on
     * @param scheduler
     *   type of scheduler this schedule gets executed on
     * @param submission_time
     *   timestamp of schedules submission
     * @param begin
     *   time the schedule begins execution
     * @param execution_time
     *   time the schedule gets executed
     */
     ...
     * returns
     *   tuple consisting of begin, scheduler and execution_time values
     */
     ...
     * @returns
     *   True if schedule exists at timestamp. False otherwise.
     */
     ...
     *   timestamp to check against
     * @returns
     *   True if the schedule gets executed at timestamp. False otherwise.
     */
