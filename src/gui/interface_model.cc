...
int InterfaceModel::scheduler_offset(int row) const {
    int scheduler_height_before = row * interface_config.unit.height_px;
    int distance_before = (1 + row) * interface_config.player.scheduler_distance_px;
